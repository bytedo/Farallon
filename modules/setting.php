...
class farallonSetting
{
    ...
    function setting_callback()
    {
        ...
        if (!current_user_can('manage_options')) {
            wp_send_json(['code' => 403, 'message' => '权限不足'], 403);
        }
        check_ajax_referer('farallon_setting', 'nonce');
        ...
        if (isset($_GET['page']) && $_GET['page'] == 'farallon') {
            ...
            wp_localize_script(
                ...
                [
                    ...
                    'settingNonce' => wp_create_nonce('farallon_setting'),
            ...
            [
                ...
                'content' => [
                    ...
                    [
                        'type' => 'input',
                        'name' => 'cos_domain',
                        'label' => __('COS Domain', 'Farallon'),
                        'description' => __('Tencent Cloud COS domain, thumbnails will be cropped automatically.', 'Farallon')
                    ],
                    [
                        'type' => 'switch',
                        'name' => 'darkmode',
