...
<?php }
    ...
    function farallon_toc($content)
    {
        ...
        if ($matches && is_singular()) {
            ...
            foreach ($matches as $match) {
                ...
                $toc .= sprintf('<li><a href="#toc-%s">%s</a>', $count, esc_html($title));
    ...
    function head_output()
    {
        ...
        $description = '';
        $ogmeta = '<meta property="og:title" content="' . esc_attr(wp_get_document_title()) . '">';
        $ogmeta .= '<meta property="og:url" content="' . esc_url($current_url) . '">';
        if (is_singular()) {
            $ID = $post->ID;
            ...
            $ogmeta .= '<meta property="og:image" content="' . esc_url(farallon_get_background_image($ID)) . '">';
            $ogmeta .= '<meta property="og:description" content="' . esc_attr($description) . '">';
            $ogmeta .= '<meta property="og:type" content="article">';
            $twitter_meta = '<meta name="twitter:card" content="summary_large_image">';
            $twitter_meta .= '<meta name="twitter:image:src" content="' . esc_url(farallon_get_background_image($post->ID)) . '">';
            $twitter_meta .= '<meta name="twitter:site" content="@fatesinger">';
            $twitter_meta .= '<meta name="twitter:title" content="' . esc_attr($post->post_title) . '">';
            $twitter_meta .= '<meta name="twitter:description" content="' . esc_attr($description) . '">';
            echo $twitter_meta;
        } else {
            if (is_home()) {
            ...
            if ($farallonSetting->get_setting('og_default_thumb')) {
                $ogmeta .= '<meta property="og:image" content="' . esc_url($farallonSetting->get_setting('og_default_thumb')) . '">';
            }
            if ($description) $ogmeta .= '<meta property="og:description" content="' . esc_attr($description) . '">';
